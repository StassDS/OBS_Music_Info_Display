...
- Чтобы это сделать нужно зайти в менеджер разширений в браузере ([Opera](opera://extensions)) ([Chrome](Chrome://extensions)) ([Vivaldi](vivaldi://extensions/)) (Для фаерфокса пока нету плагина)
